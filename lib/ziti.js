 ...
 * @param {boolean} isWebSocket - True|False indicator concerning whether this connection if bi-directional.
 ...
 * @param {string} url_or_service - The express() object.
 ...
 * @param {string[]} path - The HTTP Headers to use on the request.
 ...
 * @param reqData - Incoming response data from the HTTP request.
 * @param respData.req - The request handle.
 ...
 * @function init
 * @param {string} identityPath - A color, in hexadecimal format.
 * @returns {number} A status value ranging from 0 to 255.
 */
exports.init              = require('./init').init;

serviceName, js_arb_data, on_listen, on_listen_client, on_client_connect, on_client_data
