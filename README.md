...
* [@openziti/ziti-sdk-nodejs](#module_@openziti/ziti-sdk-nodejs)
    ...
    * [~httpRequest(url_or_service, method, path, path, onRequest, onResponse, onResponseData)](#module_@openziti/ziti-sdk-nodejs..httpRequest) ⇒ <code>void</code>
...
| isWebSocket | <code>boolean</code> | True|False indicator concerning whether this connection if bi-directional. |
...
### @openziti/ziti-sdk-nodejs~httpRequest(url_or_service, method, path, path, onRequest, onResponse, onResponseData) ⇒ <code>void</code>
...
| Param | Type | Description |
| --- | --- | --- |
| url_or_service | <code>string</code> | The express() object. |
...
| path | <code>Array.&lt;string&gt;</code> | The HTTP Headers to use on the request. |
...
| Param | Type | Description |
| --- | --- | --- |
| identityPath | <code>string</code> | A color, in hexadecimal format. |
...
| Param | Description |
| --- | --- |
| reqData | Incoming response data from the HTTP request. |
| respData.req | The request handle. |
...
Handbrake ([Authors](https://github.com/HandBrake/HandBrake/blob/master/AUTHORS.markdown)) is licensed by [GNU General Public License Version 2](https://github.com/HandBrake/HandBrake/blob/master/LICENSE).git 